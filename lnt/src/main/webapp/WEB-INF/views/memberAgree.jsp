...
<title>Insert title here</title>
        ...
        <script>
        	function agree(){
        		if($("input:checkbox[id=exampleFormControlTextarea1]").is(":checked") == false) {
        			alert("이용약관에 동의 하세요.");	  
        			return false;
        		}else if($("input:checkbox[id=exampleFormControlTextarea2]").is(":checked") == false) {
        			alert("개인 정보 수집 및 이용에 동의 하세요.");	  
        			return false;
        		}else{
        			//location.href="${pageContext.request.contextPath}/memberRegist";
        			location.href="${pageContext.request.contextPath}/emailAuth";
        		}
                        ...
                        <div class="col-xl-9 col-lg-10 mx-auto bg-faded rounded  mt-5  mb-4 p-3">
                        	<form>
								<div class="form-group">
									    ...
									    <label for="exampleFormControlTextarea1">이용약관 동의 <span style="color:red">(필수)</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox"  id="exampleFormControlTextarea1" class="form-check-input"/></label>
									    <textarea class="form-control" rows="8">
제 1장 총칙
제 1 조 (목적)
이 이용약관은 "Leave No Trace (이하 '당 사이트')"에서 제공하는 인터넷 서비스(이하 '서비스')의 가입조건, 당 사이트와 이용자의 권리, 의무, 책임사항과 기타 필요한 사항을 규정함을 목적으로 합니다.

제 2 조 (용어의 정의)
1. "이용자"라 함은 당 사이트에 접속하여 이 약관에 따라 당 사이트가 제공하는 서비스를 받는 회원 및 비회원을 말합니다.
2. "Leave No Trace" 에서 제공하는 국가표준, 인증제도, 기술기준, 인증지원 정보를 말합니다.
3. "회원"이라 함은 서비스를 이용하기 위하여 당 사이트에 개인정보를 제공하여 아이디(ID)와 비밀번호를 부여 받은 자를 말합니다.
4. "비회원"이하 함은 회원으로 가입하지 않고 "Leave No Trace" 에서 제공하는 서비스를 이용하는 자를 말합니다.
...
2. 이 약관에 명시되지 아니한 사항은 관계법령의 규정이 적용됩니다.
								...
								<div class="form-group">
									    <label for="exampleFormControlTextarea2">개인 정보 수집 및 이용 <span style="color:red">(필수)</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox"  id="exampleFormControlTextarea2" class="form-check-input"/></label>
...
제 7 장 "Leave No Trace" 게시물 운영정책
제 20 조 (운영정책)
"Leave No Trace" 각종 게시물에 대한 운영정책은 방송통신심의위원회의 정보통신에 관한 심의규정에 기반하며 이를 위반할 경우, "Leave No Trace" 운영정책에 의해 관련 게시물은 예고 없이 삭제, 이동될 수 있으며, 게시자(회원)는 아이디 이용제한 등 "Leave No Trace" 이용에 제한을 받을 수 있습니다.
...
다른 회원의 게시물로 인하여 명예훼손, 저작권 침해 등의 피해를 입었을 경우, 운영담당자를 통해 해당 게시물에 대한 게시중단을 요청하실 수 있습니다.
								...
								<input type="button" class="btn btn-primary" onclick="agree()" value="동의합니다"/>
							</form>
                        </div>
                    </div>
                </div>
