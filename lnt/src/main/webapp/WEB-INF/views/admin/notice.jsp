            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <h1 class="h3 mb-2 text-gray-800">Notice</h1>
                     <p style="color:red">이미지 업로드시 이미지 너비값은 '100%' 로 하시고, 이미지 높이값은 공란으로 두세요.</p>
                    <!-- DataTales Example -->
                    <div class="card shadow mb-4">
                        <div class="card-body">
                            <form id="form" method="post" action="${pageContext.request.contextPath}/admin/noticeregist" enctype="multipart/form-data" >
								<p><input type="text" class="form-control" id="subject" name="subject" placeholder="제목" required="required" /></p>
								<p><textarea rows="15" cols="50" id="contents" name="contents" required="required" ></textarea></p>
								<script>
								 var ckeditor_config = {
								   resize_enaleb : false,
								   enterMode : CKEDITOR.ENTER_BR,
								   shiftEnterMode : CKEDITOR.ENTER_P,
								   filebrowserUploadUrl : "${pageContext.request.contextPath}/admin/noticeCkUpload"
								 };
								 
								 CKEDITOR.replace("contents", ckeditor_config);
							</script>
                           	<p class="fieldlabels">첨부파일이 있다면 첨부해 주세요</p>
							 <input type="file" name="uploadfile"  id="uploadfile">
                       			<br><br>
							     <p> <input type="submit" class="btn btn-primary" value="등록" id="save">
							     <a href="${pageContext.request.contextPath}/admin/noticeList" class="btn btn-secondary">목록보기</a></p>
