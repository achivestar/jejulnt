        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Notice Modify</h1>
                    <!-- DataTales Example -->
                    <div class="card shadow mb-4">
                        <div class="card-body">
                           <form id="form" method="post" action="${pageContext.request.contextPath}/admin/noticeUpdate" enctype="multipart/form-data" >
								...
								<script>
								 var ckeditor_config = {
								   ...
								   filebrowserUploadUrl : "${pageContext.request.contextPath}/admin/ckUpdateNoticeUpload?idx=${thumbvo.idx}"
								 };
